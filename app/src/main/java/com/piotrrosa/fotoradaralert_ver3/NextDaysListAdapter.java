 ...
 */
public class NextDaysListAdapter extends ArrayAdapter<Location> {

    public NextDaysListAdapter(Context context, ArrayList<Location> locations) {
    ...
    public View getView (int position, View convertView, ViewGroup parent) {
        ...
        if(endDate==null) {
            ...
            startTimeImageView.setVisibility(View.INVISIBLE);
